...
# Generated by /human-voice:voice-setup on [date]
...
If yes:
- Run `/human-voice:voice-review` on detected content directories
- Report summary of findings
- Suggest running `/human-voice:voice-fix` if character issues found
...
3. Run `/human-voice:voice-review` to scan content
4. Run `/human-voice:voice-fix` to auto-fix character issues
